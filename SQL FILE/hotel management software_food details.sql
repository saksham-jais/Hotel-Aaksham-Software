...
--
-- Table structure for table `food details`
--

DROP TABLE IF EXISTS `food details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `food details` (
...
--
-- Dumping data for table `food details`
--

LOCK TABLES `food details` WRITE;
/*!40000 ALTER TABLE `food details` DISABLE KEYS */;
/*!40000 ALTER TABLE `food details` ENABLE KEYS */;
UNLOCK TABLES;
