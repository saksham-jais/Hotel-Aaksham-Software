...
--
-- Table structure for table `bar_details`
--
...
--
-- Dumping data for table `bar_details`
--

LOCK TABLES `bar_details` WRITE;
/*!40000 ALTER TABLE `bar_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `bar_details` ENABLE KEYS */;
UNLOCK TABLES;
